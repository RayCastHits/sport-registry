# Generated by Django 3.0.4 on 2020-04-18 16:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.BooleanField(choices=[(False, 'М'), (True, 'Ж')], max_length=10, verbose_name='Пол')),
                ('location', models.TextField(blank=True, null=True, verbose_name='Место жительства')),
        ...
        migrations.AddField(
            ...
            name='sport_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registry.SportType', verbose_name='Вид спорта'),
        ),
        migrations.CreateModel(
            name='Parent',
            fields=[
